...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Grimmr (Tiny Planet Studios)", "Projectcrashland", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Project crash land";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Project crash land", null, { width: 1280, height: 720 });
