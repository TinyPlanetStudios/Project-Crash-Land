...
Bool Reflect_obj::hasField( ::Dynamic o,::String field){
            	HX_STACK_FRAME("Reflect","hasField",0xef8c2571,"Reflect.hasField","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",30,0xc9a24bcf)
            	HX_STACK_ARG(o,"o")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Reflect_obj,hasField,return )
 ...
 ::Dynamic Reflect_obj::field( ::Dynamic o,::String field){
            	HX_STACK_FRAME("Reflect","field",0x54b04da9,"Reflect.field","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",34,0xc9a24bcf)
            	HX_STACK_ARG(o,"o")
            	HX_STACK_ARG(field,"field")
...
void Reflect_obj::setField( ::Dynamic o,::String field, ::Dynamic value){
            	HX_STACK_FRAME("Reflect","setField",0x71684429,"Reflect.setField","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",38,0xc9a24bcf)
            	HX_STACK_ARG(o,"o")
            	HX_STACK_ARG(field,"field")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Reflect_obj,setField,(void))
 ...
 ::Dynamic Reflect_obj::getProperty( ::Dynamic o,::String field){
            	HX_STACK_FRAME("Reflect","getProperty",0x632ca13a,"Reflect.getProperty","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",43,0xc9a24bcf)
            	HX_STACK_ARG(o,"o")
            	HX_STACK_ARG(field,"field")
...
void Reflect_obj::setProperty( ::Dynamic o,::String field, ::Dynamic value){
            	HX_STACK_FRAME("Reflect","setProperty",0x6d99a846,"Reflect.setProperty","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",47,0xc9a24bcf)
            	HX_STACK_ARG(o,"o")
            	HX_STACK_ARG(field,"field")
            	HX_STACK_ARG(value,"value")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Reflect_obj,setProperty,(void))
 ...
 ::Dynamic Reflect_obj::callMethod( ::Dynamic o, ::Dynamic func,::cpp::VirtualArray args){
            	HX_STACK_FRAME("Reflect","callMethod",0xb49e52d0,"Reflect.callMethod","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",51,0xc9a24bcf)
            	HX_STACK_ARG(o,"o")
...
::Array< ::String > Reflect_obj::fields( ::Dynamic o){
            	HX_STACK_FRAME("Reflect","fields",0xc593a6aa,"Reflect.fields","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",58,0xc9a24bcf)
            	HX_STACK_ARG(o,"o")
...
Bool Reflect_obj::isFunction( ::Dynamic f){
            	HX_STACK_FRAME("Reflect","isFunction",0x0f1541d3,"Reflect.isFunction","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",66,0xc9a24bcf)
            	HX_STACK_ARG(f,"f")
...
Int Reflect_obj::compare( ::Dynamic a, ::Dynamic b){
            	HX_STACK_FRAME("Reflect","compare",0xa2d92b54,"Reflect.compare","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",70,0xc9a24bcf)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
...
Bool Reflect_obj::compareMethods( ::Dynamic f1, ::Dynamic f2){
            	HX_STACK_FRAME("Reflect","compareMethods",0x8b8ddd7e,"Reflect.compareMethods","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",73,0xc9a24bcf)
            	HX_STACK_ARG(f1,"f1")
            	HX_STACK_ARG(f2,"f2")
...
Bool Reflect_obj::isObject( ::Dynamic v){
            	HX_STACK_FRAME("Reflect","isObject",0xd04960ba,"Reflect.isObject","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",81,0xc9a24bcf)
            	HX_STACK_ARG(v,"v")
...
Bool Reflect_obj::isEnumValue( ::Dynamic v){
            	HX_STACK_FRAME("Reflect","isEnumValue",0x97884d95,"Reflect.isEnumValue","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",89,0xc9a24bcf)
            	HX_STACK_ARG(v,"v")
...
Bool Reflect_obj::deleteField( ::Dynamic o,::String field){
            	HX_STACK_FRAME("Reflect","deleteField",0x21895ebe,"Reflect.deleteField","C:\\Haxe\\haxe\\std/cpp/_std/Reflect.hx",92,0xc9a24bcf)
            	HX_STACK_ARG(o,"o")
            	HX_STACK_ARG(field,"field")
