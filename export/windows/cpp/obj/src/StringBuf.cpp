...
void StringBuf_obj::__construct(){
            	HX_STACK_FRAME("StringBuf","new",0xaaa8f4b4,"StringBuf.new","C:\\Haxe\\haxe\\std/cpp/_std/StringBuf.hx",32,0x144601ca)
            	HX_STACK_THIS(this)
...
void StringBuf_obj::flush(){
            	HX_STACK_FRAME("StringBuf","flush",0xc7c14418,"StringBuf.flush","C:\\Haxe\\haxe\\std/cpp/_std/StringBuf.hx",35,0x144601ca)
            	HX_STACK_THIS(this)
