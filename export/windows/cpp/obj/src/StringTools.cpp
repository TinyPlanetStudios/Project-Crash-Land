...
::String StringTools_obj::urlEncode(::String s){
            	HX_STACK_FRAME("StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","C:\\Haxe\\haxe\\std/StringTools.hx",45,0xc65d7885)
            	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::urlDecode(::String s){
            	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","C:\\Haxe\\haxe\\std/StringTools.hx",115,0xc65d7885)
            	HX_STACK_ARG(s,"s")
...
Bool StringTools_obj::startsWith(::String s,::String start){
            	HX_STACK_FRAME("StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","C:\\Haxe\\haxe\\std/StringTools.hx",183,0xc65d7885)
            	HX_STACK_ARG(s,"s")
...
Bool StringTools_obj::endsWith(::String s,::String end){
            	HX_STACK_FRAME("StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","C:\\Haxe\\haxe\\std/StringTools.hx",211,0xc65d7885)
            	HX_STACK_ARG(s,"s")
...
Bool StringTools_obj::isSpace(::String s,Int pos){
            	HX_STACK_FRAME("StringTools","isSpace",0xe0290778,"StringTools.isSpace","C:\\Haxe\\haxe\\std/StringTools.hx",245,0xc65d7885)
            	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACK_FRAME("StringTools","ltrim",0x24d2234a,"StringTools.ltrim","C:\\Haxe\\haxe\\std/StringTools.hx",262,0xc65d7885)
            	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACK_FRAME("StringTools","rtrim",0x99399e50,"StringTools.rtrim","C:\\Haxe\\haxe\\std/StringTools.hx",287,0xc65d7885)
            	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::trim(::String s){
            	HX_STACK_FRAME("StringTools","trim",0x2908d066,"StringTools.trim","C:\\Haxe\\haxe\\std/StringTools.hx",315,0xc65d7885)
            	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACK_FRAME("StringTools","replace",0x6d651f30,"StringTools.replace","C:\\Haxe\\haxe\\std/StringTools.hx",386,0xc65d7885)
            	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::hex(Int n, ::Dynamic digits){
            	HX_STACK_FRAME("StringTools","hex",0xd91debd7,"StringTools.hex","C:\\Haxe\\haxe\\std/StringTools.hx",396,0xc65d7885)
            	HX_STACK_ARG(n,"n")
