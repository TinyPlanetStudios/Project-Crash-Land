...
HXDLIN( 241)		return (_hx_tmp1 < ((Float)9.9999999999999984e-015));
            	}
...
HXDLIN( 387)		if ((_hx_tmp1 < ((Float)9.9999999999999984e-015))) {
HXLINE( 387)			return ::Math_obj::NaN;
            		}
HXLINE( 388)		Bool _hx_tmp2;
HXDLIN( 388)		if (!((((this->x * this->x) + (this->y * this->y)) < ((Float)9.9999999999999984e-015)))) {
HXLINE( 388)			_hx_tmp2 = (((v->x * v->x) + (v->y * v->y)) < ((Float)9.9999999999999984e-015));
            		}
            		else {
