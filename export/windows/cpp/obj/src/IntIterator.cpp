...
void IntIterator_obj::__construct(Int min,Int max){
            	HX_STACK_FRAME("IntIterator","new",0x5692054f,"IntIterator.new","C:\\Haxe\\haxe\\std/IntIterator.hx",46,0xf3b2ebf2)
            	HX_STACK_THIS(this)
...
Bool IntIterator_obj::hasNext(){
            	HX_STACK_FRAME("IntIterator","hasNext",0xd8737ddc,"IntIterator.hasNext","C:\\Haxe\\haxe\\std/IntIterator.hx",55,0xf3b2ebf2)
            	HX_STACK_THIS(this)
...
Int IntIterator_obj::next(){
            	HX_STACK_FRAME("IntIterator","next",0x6932a124,"IntIterator.next","C:\\Haxe\\haxe\\std/IntIterator.hx",64,0xf3b2ebf2)
            	HX_STACK_THIS(this)
