...
void List_obj::__construct(){
            	HX_STACK_FRAME("List","new",0xed890070,"List.new","C:\\Haxe\\haxe\\std/List.hx",44,0xa8f1d5ef)
            	HX_STACK_THIS(this)
...
void List_obj::add( ::Dynamic item){
            	HX_STACK_FRAME("List","add",0xed7f2231,"List.add","C:\\Haxe\\haxe\\std/List.hx",52,0xa8f1d5ef)
            	HX_STACK_THIS(this)
...
void List_obj::push( ::Dynamic item){
            	HX_STACK_FRAME("List","push",0xebb5efca,"List.push","C:\\Haxe\\haxe\\std/List.hx",67,0xa8f1d5ef)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(item,"item")
...
Bool List_obj::isEmpty(){
            	HX_STACK_FRAME("List","isEmpty",0xaa565653,"List.isEmpty","C:\\Haxe\\haxe\\std/List.hx",114,0xa8f1d5ef)
            	HX_STACK_THIS(this)
...
Bool List_obj::remove( ::Dynamic v){
            	HX_STACK_FRAME("List","remove",0x4b44d634,"List.remove","C:\\Haxe\\haxe\\std/List.hx",137,0xa8f1d5ef)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,remove,return )
 ...
 ::_List::ListIterator List_obj::iterator(){
            	HX_STACK_FRAME("List","iterator",0x2d4cdfde,"List.iterator","C:\\Haxe\\haxe\\std/List.hx",161,0xa8f1d5ef)
            	HX_STACK_THIS(this)
