...
HXLINE(  29)		::openfl::_legacy::Lib_obj::setPackage(HX_("Grimmr (Tiny Planet Studios)",90,29,6e,63),HX_("Projectcrashland",79,6b,15,bc),HX_("com.example.myapp",84,30,57,c1),HX_("0.0.1",35,3d,c8,c1));
...
HXLINE(  52)		::openfl::_legacy::Lib_obj::create( ::Dynamic(new _hx_Closure_0()),(int)1280,(int)720,(int)60,(int)0,((int)((int)_hx_tmp | (int)(int)0) | (int)(int)0),HX_("Project crash land",cb,76,69,bc),null(),null());
            	}
