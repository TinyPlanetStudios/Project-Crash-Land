...
void EReg_obj::__construct(::String r,::String opt){
            	HX_STACK_FRAME("EReg","new",0x8b859e81,"EReg.new","C:\\Haxe\\haxe\\std/cpp/_std/EReg.hx",30,0xfe52d241)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(r,"r")
...
Bool EReg_obj::match(::String s){
            	HX_STACK_FRAME("EReg","match",0x18fda1a6,"EReg.match","C:\\Haxe\\haxe\\std/cpp/_std/EReg.hx",38,0xfe52d241)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
::String EReg_obj::matched(Int n){
            	HX_STACK_FRAME("EReg","matched",0x8ce62f85,"EReg.matched","C:\\Haxe\\haxe\\std/cpp/_std/EReg.hx",49,0xfe52d241)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(n,"n")
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACK_FRAME("EReg","split",0x9749433b,"EReg.split","C:\\Haxe\\haxe\\std/cpp/_std/EReg.hx",76,0xfe52d241)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
::String EReg_obj::replace(::String s,::String by){
            	HX_STACK_FRAME("EReg","replace",0xae923ad5,"EReg.replace","C:\\Haxe\\haxe\\std/cpp/_std/EReg.hx",100,0xfe52d241)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(by,"by")
