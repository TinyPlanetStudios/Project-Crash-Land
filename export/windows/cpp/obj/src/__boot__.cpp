...
::entity::Ladder_obj::__register();
::entity::Interactable_obj::__register();
::entity::Cover_obj::__register();
...
::WrenchPickup_obj::__register();
::Type_obj::__register();
::TrapDoorCode_obj::__register();
...
::GravZone_obj::__register();
::FuelCellGet_obj::__register();
::EReg_obj::__register();
::cpp::vm::Deque_obj::__register();
::openfl::_legacy::AssetLibrary_obj::__register();
::Date_obj::__register();
::Cutscene_obj::__register();
::CodeDoorKeypad_obj::__register();
