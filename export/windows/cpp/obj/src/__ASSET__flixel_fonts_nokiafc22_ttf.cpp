...
::String filename = __o_filename.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACK_FRAME("__ASSET__flixel_fonts_nokiafc22_ttf","new",0x22f03f2a,"__ASSET__flixel_fonts_nokiafc22_ttf.new","DefaultAssetLibrary.hx",601,0x0fc48912)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(filename,"filename")
            	HX_STACK_ARG(style,"style")
            	HX_STACK_ARG(type,"type")
HXLINE( 601)		super::__construct(filename,style,type);
            	}
