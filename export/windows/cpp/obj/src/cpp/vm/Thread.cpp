...
void Thread_obj::__construct( ::Dynamic h){
            	HX_STACK_FRAME("cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","C:\\Haxe\\haxe\\std/cpp/vm/Thread.hx",31,0x32d976d9)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(h,"h")
...
void Thread_obj::sendMessage( ::Dynamic msg){
            	HX_STACK_FRAME("cpp.vm.Thread","sendMessage",0x48dced27,"cpp.vm.Thread.sendMessage","C:\\Haxe\\haxe\\std/cpp/vm/Thread.hx",38,0x32d976d9)
            	HX_STACK_THIS(this)
...
Int Thread_obj::__compare( ::Dynamic t){
            	HX_STACK_FRAME("cpp.vm.Thread","__compare",0x3204cb4d,"cpp.vm.Thread.__compare","C:\\Haxe\\haxe\\std/cpp/vm/Thread.hx",66,0x32d976d9)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
...
HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,__compare,return )
 ...
 ::cpp::vm::Thread Thread_obj::current(){
            	HX_STACK_FRAME("cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","C:\\Haxe\\haxe\\std/cpp/vm/Thread.hx",46,0x32d976d9)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Thread_obj,current,return )
 ...
 ::cpp::vm::Thread Thread_obj::create( ::Dynamic callb){
            	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","C:\\Haxe\\haxe\\std/cpp/vm/Thread.hx",53,0x32d976d9)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,create,return )
 ...
 ::Dynamic Thread_obj::readMessage(Bool block){
            	HX_STACK_FRAME("cpp.vm.Thread","readMessage",0x11bc2cd9,"cpp.vm.Thread.readMessage","C:\\Haxe\\haxe\\std/cpp/vm/Thread.hx",62,0x32d976d9)
