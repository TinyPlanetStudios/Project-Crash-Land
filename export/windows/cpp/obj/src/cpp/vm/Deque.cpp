...
void Deque_obj::__construct(){
            	HX_STACK_FRAME("cpp.vm.Deque","new",0xa6685326,"cpp.vm.Deque.new","C:\\Haxe\\haxe\\std/cpp/vm/Deque.hx",28,0xbad3a999)
            	HX_STACK_THIS(this)
...
void Deque_obj::add( ::Dynamic i){
            	HX_STACK_FRAME("cpp.vm.Deque","add",0xa65e74e7,"cpp.vm.Deque.add","C:\\Haxe\\haxe\\std/cpp/vm/Deque.hx",31,0xbad3a999)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
...
HX_DEFINE_DYNAMIC_FUNC1(Deque_obj,add,(void))
 ...
 ::Dynamic Deque_obj::pop(Bool block){
            	HX_STACK_FRAME("cpp.vm.Deque","pop",0xa669e057,"cpp.vm.Deque.pop","C:\\Haxe\\haxe\\std/cpp/vm/Deque.hx",37,0xbad3a999)
            	HX_STACK_THIS(this)
