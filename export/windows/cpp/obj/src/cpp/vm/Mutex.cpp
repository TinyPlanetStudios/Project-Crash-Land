...
void Mutex_obj::acquire(){
            	HX_STACK_FRAME("cpp.vm.Mutex","acquire",0xc3527bfb,"cpp.vm.Mutex.acquire","C:\\Haxe\\haxe\\std/cpp/vm/Mutex.hx",31,0x6028f39a)
            	HX_STACK_THIS(this)
...
void Mutex_obj::release(){
            	HX_STACK_FRAME("cpp.vm.Mutex","release",0x675bb5ec,"cpp.vm.Mutex.release","C:\\Haxe\\haxe\\std/cpp/vm/Mutex.hx",37,0x6028f39a)
            	HX_STACK_THIS(this)
