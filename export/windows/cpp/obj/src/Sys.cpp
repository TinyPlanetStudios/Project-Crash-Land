...
void Sys_obj::println( ::Dynamic v){
            	HX_STACK_FRAME("Sys","println",0x3905f76e,"Sys.println","C:\\Haxe\\haxe\\std/cpp/_std/Sys.hx",31,0x3c95d5ff)
            	HX_STACK_ARG(v,"v")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Sys_obj,println,(void))
 ...
 ::haxe::io::Output Sys_obj::_hx_stderr(){
            	HX_STACK_FRAME("Sys","stderr",0x3eb04003,"Sys.stderr","C:\\Haxe\\haxe\\std/cpp/_std/Sys.hx",46,0x3c95d5ff)
...
::Array< ::String > Sys_obj::args(){
            	HX_STACK_FRAME("Sys","args",0xeaeddc7e,"Sys.args","C:\\Haxe\\haxe\\std/cpp/_std/Sys.hx",54,0x3c95d5ff)
...
void Sys_obj::sleep(Float seconds){
            	HX_STACK_FRAME("Sys","sleep",0xfe70aad6,"Sys.sleep","C:\\Haxe\\haxe\\std/cpp/_std/Sys.hx",69,0x3c95d5ff)
...
::String Sys_obj::getCwd(){
            	HX_STACK_FRAME("Sys","getCwd",0xd9ded99b,"Sys.getCwd","C:\\Haxe\\haxe\\std/cpp/_std/Sys.hx",77,0x3c95d5ff)
...
void Sys_obj::setCwd(::String s){
            	HX_STACK_FRAME("Sys","setCwd",0xa6272e0f,"Sys.setCwd","C:\\Haxe\\haxe\\std/cpp/_std/Sys.hx",81,0x3c95d5ff)
            	HX_STACK_ARG(s,"s")
...
void Sys_obj::exit(Int code){
            	HX_STACK_FRAME("Sys","exit",0xed97463f,"Sys.exit","C:\\Haxe\\haxe\\std/cpp/_std/Sys.hx",107,0x3c95d5ff)
...
::String Sys_obj::executablePath(){
            	HX_STACK_FRAME("Sys","executablePath",0xfc9406f0,"Sys.executablePath","C:\\Haxe\\haxe\\std/cpp/_std/Sys.hx",119,0x3c95d5ff)
