...
void JsonParser_obj::__construct(::String str){
            	HX_STACK_FRAME("haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","C:\\Haxe\\haxe\\std/haxe/format/JsonParser.hx",51,0x0d8f9c37)
            	HX_STACK_THIS(this)
...
Dynamic JsonParser_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic JsonParser_obj::parseRec(){
            	HX_STACK_FRAME("haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","C:\\Haxe\\haxe\\std/haxe/format/JsonParser.hx",57,0x0d8f9c37)
            	HX_STACK_THIS(this)
...
::String JsonParser_obj::parseString(){
            	HX_STACK_FRAME("haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","C:\\Haxe\\haxe\\std/haxe/format/JsonParser.hx",138,0x0d8f9c37)
            	HX_STACK_THIS(this)
...
void JsonParser_obj::invalidChar(){
            	HX_STACK_FRAME("haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","C:\\Haxe\\haxe\\std/haxe/format/JsonParser.hx",249,0x0d8f9c37)
            	HX_STACK_THIS(this)
HXLINE( 250)		this->pos--;
...
void JsonParser_obj::invalidNumber(Int start){
            	HX_STACK_FRAME("haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","C:\\Haxe\\haxe\\std/haxe/format/JsonParser.hx",255,0x0d8f9c37)
            	HX_STACK_THIS(this)
