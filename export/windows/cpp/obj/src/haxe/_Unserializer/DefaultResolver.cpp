...
void DefaultResolver_obj::__construct(){
            	HX_STACK_FRAME("haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","C:\\Haxe\\haxe\\std/haxe/Unserializer.hx",471,0x81c40bdb)
            	HX_STACK_THIS(this)
            	}
...
hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACK_FRAME("haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","C:\\Haxe\\haxe\\std/haxe/Unserializer.hx",472,0x81c40bdb)
            	HX_STACK_THIS(this)
...
hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACK_FRAME("haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","C:\\Haxe\\haxe\\std/haxe/Unserializer.hx",473,0x81c40bdb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
