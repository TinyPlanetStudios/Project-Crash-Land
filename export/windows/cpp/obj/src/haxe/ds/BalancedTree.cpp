...
void BalancedTree_obj::__construct(){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","new",0xfb50b0cf,"haxe.ds.BalancedTree.new","C:\\Haxe\\haxe\\std/haxe/ds/BalancedTree.hx",41,0x8920e1d0)
            	HX_STACK_THIS(this)
            	}
...
void BalancedTree_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","set",0xfb547c11,"haxe.ds.BalancedTree.set","C:\\Haxe\\haxe\\std/haxe/ds/BalancedTree.hx",51,0x8920e1d0)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(BalancedTree_obj,set,(void))
 ...
 ::Dynamic BalancedTree_obj::get( ::Dynamic key){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","get",0xfb4b6105,"haxe.ds.BalancedTree.get","C:\\Haxe\\haxe\\std/haxe/ds/BalancedTree.hx",61,0x8920e1d0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
HX_DEFINE_DYNAMIC_FUNC1(BalancedTree_obj,get,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::setLoop( ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode node){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","setLoop",0xe1a32b15,"haxe.ds.BalancedTree.setLoop","C:\\Haxe\\haxe\\std/haxe/ds/BalancedTree.hx",132,0x8920e1d0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(k,"k")
            	HX_STACK_ARG(v,"v")
...
HX_DEFINE_DYNAMIC_FUNC3(BalancedTree_obj,setLoop,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::balance( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","balance",0xf7f4e10b,"haxe.ds.BalancedTree.balance","C:\\Haxe\\haxe\\std/haxe/ds/BalancedTree.hx",187,0x8920e1d0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(l,"l")
            	HX_STACK_ARG(k,"k")
            	HX_STACK_ARG(v,"v")
...
Int BalancedTree_obj::compare( ::Dynamic k1, ::Dynamic k2){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","compare",0x57d05c94,"haxe.ds.BalancedTree.compare","C:\\Haxe\\haxe\\std/haxe/ds/BalancedTree.hx",202,0x8920e1d0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(k1,"k1")
            	HX_STACK_ARG(k2,"k2")
