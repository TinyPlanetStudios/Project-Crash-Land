...
void NodeListAccess_obj::__construct( ::Xml x){
            	HX_STACK_FRAME("haxe.xml._Fast.NodeListAccess","new",0x22c8c708,"haxe.xml._Fast.NodeListAccess.new","C:\\Haxe\\haxe\\std/haxe/xml/Fast.hx",97,0xbaa3a892)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
Dynamic NodeListAccess_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::List NodeListAccess_obj::resolve(::String name){
            	HX_STACK_FRAME("haxe.xml._Fast.NodeListAccess","resolve",0x21d97d94,"haxe.xml._Fast.NodeListAccess.resolve","C:\\Haxe\\haxe\\std/haxe/xml/Fast.hx",100,0xbaa3a892)
            	HX_STACK_THIS(this)
