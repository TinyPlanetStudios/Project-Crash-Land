...
void HasAttribAccess_obj::__construct( ::Xml x){
            	HX_STACK_FRAME("haxe.xml._Fast.HasAttribAccess","new",0x4d025ce8,"haxe.xml._Fast.HasAttribAccess.new","C:\\Haxe\\haxe\\std/haxe/xml/Fast.hx",67,0xbaa3a892)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
Bool HasAttribAccess_obj::resolve(::String name){
            	HX_STACK_FRAME("haxe.xml._Fast.HasAttribAccess","resolve",0x0ac38374,"haxe.xml._Fast.HasAttribAccess.resolve","C:\\Haxe\\haxe\\std/haxe/xml/Fast.hx",70,0xbaa3a892)
            	HX_STACK_THIS(this)
