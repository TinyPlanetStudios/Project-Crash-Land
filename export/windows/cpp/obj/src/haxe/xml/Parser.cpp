...
Bool strict = __o_strict.Default(false);
            	HX_STACK_FRAME("haxe.xml.Parser","parse",0x937905c3,"haxe.xml.Parser.parse","C:\\Haxe\\haxe\\std/haxe/xml/Parser.hx",120,0xc837f62f)
...
Int p = __o_p.Default(0);
            	HX_STACK_FRAME("haxe.xml.Parser","doParse",0x2e9a6a38,"haxe.xml.Parser.doParse","C:\\Haxe\\haxe\\std/haxe/xml/Parser.hx",127,0xc837f62f)
            	HX_STACK_ARG(str,"str")
            	HX_STACK_ARG(strict,"strict")
            	HX_STACK_ARG(p,"p")
...
{
{
            	HX_STACK_FRAME("haxe.xml.Parser","boot",0x0af6f0a2,"haxe.xml.Parser.boot","C:\\Haxe\\haxe\\std/haxe/xml/Parser.hx",104,0xc837f62f)
