...
void XmlParserException_obj::__construct(::String message,::String xml,Int position){
            	HX_STACK_FRAME("haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","C:\\Haxe\\haxe\\std/haxe/xml/Parser.hx",77,0xc837f62f)
            	HX_STACK_THIS(this)
...
::String XmlParserException_obj::toString(){
            	HX_STACK_FRAME("haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","C:\\Haxe\\haxe\\std/haxe/xml/Parser.hx",98,0xc837f62f)
            	HX_STACK_THIS(this)
