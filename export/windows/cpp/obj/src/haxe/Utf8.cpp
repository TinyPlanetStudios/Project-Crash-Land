...
Int Utf8_obj::charCodeAt(::String s,Int index){
            	HX_STACK_FRAME("haxe.Utf8","charCodeAt",0xce7cbeab,"haxe.Utf8.charCodeAt","C:\\Haxe\\haxe\\std/cpp/_std/haxe/Utf8.hx",66,0x5af24c72)
            	HX_STACK_ARG(s,"s")
...
Int Utf8_obj::length(::String s){
            	HX_STACK_FRAME("haxe.Utf8","length",0x88322e1b,"haxe.Utf8.length","C:\\Haxe\\haxe\\std/cpp/_std/haxe/Utf8.hx",74,0x5af24c72)
            	HX_STACK_ARG(s,"s")
