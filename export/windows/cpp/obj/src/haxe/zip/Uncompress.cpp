...
void Uncompress_obj::__construct( ::Dynamic windowBits){
            	HX_STACK_FRAME("haxe.zip.Uncompress","new",0x34f307c2,"haxe.zip.Uncompress.new","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",29,0x39c94a3a)
            	HX_STACK_THIS(this)
...
Dynamic Uncompress_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Uncompress_obj::execute( ::haxe::io::Bytes src,Int srcPos, ::haxe::io::Bytes dst,Int dstPos){
            	HX_STACK_FRAME("haxe.zip.Uncompress","execute",0xb3589a97,"haxe.zip.Uncompress.execute","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",33,0x39c94a3a)
            	HX_STACK_THIS(this)
...
void Uncompress_obj::setFlushMode(::hx::EnumBase f){
            	HX_STACK_FRAME("haxe.zip.Uncompress","setFlushMode",0xbecba0a3,"haxe.zip.Uncompress.setFlushMode","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",37,0x39c94a3a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
void Uncompress_obj::close(){
            	HX_STACK_FRAME("haxe.zip.Uncompress","close",0x4cc86b9a,"haxe.zip.Uncompress.close","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",41,0x39c94a3a)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Uncompress_obj,close,(void))
 ...
 ::haxe::io::Bytes Uncompress_obj::run( ::haxe::io::Bytes src, ::Dynamic bufsize){
            	HX_STACK_FRAME("haxe.zip.Uncompress","run",0x34f61ead,"haxe.zip.Uncompress.run","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",44,0x39c94a3a)
            	HX_STACK_ARG(src,"src")
