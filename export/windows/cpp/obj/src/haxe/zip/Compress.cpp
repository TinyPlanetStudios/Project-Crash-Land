...
void Compress_obj::__construct(Int level){
            	HX_STACK_FRAME("haxe.zip.Compress","new",0x4ddc50a9,"haxe.zip.Compress.new","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",30,0x0024f033)
            	HX_STACK_THIS(this)
...
Dynamic Compress_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Compress_obj::execute( ::haxe::io::Bytes src,Int srcPos, ::haxe::io::Bytes dst,Int dstPos){
            	HX_STACK_FRAME("haxe.zip.Compress","execute",0xd015e2fe,"haxe.zip.Compress.execute","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",34,0x0024f033)
            	HX_STACK_THIS(this)
...
void Compress_obj::setFlushMode(::hx::EnumBase f){
            	HX_STACK_FRAME("haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",38,0x0024f033)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
void Compress_obj::close(){
            	HX_STACK_FRAME("haxe.zip.Compress","close",0x6942fc41,"haxe.zip.Compress.close","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",42,0x0024f033)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Compress_obj,close,(void))
 ...
 ::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,Int level){
            	HX_STACK_FRAME("haxe.zip.Compress","run",0x4ddf6794,"haxe.zip.Compress.run","C:\\Haxe\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",45,0x0024f033)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(level,"level")
