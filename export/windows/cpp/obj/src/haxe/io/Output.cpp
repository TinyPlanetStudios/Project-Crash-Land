...
void Output_obj::writeByte(Int c){
            	HX_STACK_FRAME("haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","C:\\Haxe\\haxe\\std/haxe/io/Output.hx",47,0x6d4bf40c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(c,"c")
...
Int Output_obj::writeBytes( ::haxe::io::Bytes s,Int pos,Int len){
            	HX_STACK_FRAME("haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","C:\\Haxe\\haxe\\std/haxe/io/Output.hx",57,0x6d4bf40c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
void Output_obj::close(){
            	HX_STACK_FRAME("haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","C:\\Haxe\\haxe\\std/haxe/io/Output.hx",93,0x6d4bf40c)
            	HX_STACK_THIS(this)
            	}
...
void Output_obj::write( ::haxe::io::Bytes s){
            	HX_STACK_FRAME("haxe.io.Output","write",0x6f1d1512,"haxe.io.Output.write","C:\\Haxe\\haxe\\std/haxe/io/Output.hx",106,0x6d4bf40c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
void Output_obj::writeFullBytes( ::haxe::io::Bytes s,Int pos,Int len){
            	HX_STACK_FRAME("haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","C:\\Haxe\\haxe\\std/haxe/io/Output.hx",123,0x6d4bf40c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
...
void Output_obj::writeString(::String s){
            	HX_STACK_FRAME("haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","C:\\Haxe\\haxe\\std/haxe/io/Output.hx",278,0x6d4bf40c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
