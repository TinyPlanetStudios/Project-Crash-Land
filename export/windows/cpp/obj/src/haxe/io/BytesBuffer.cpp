...
void BytesBuffer_obj::__construct(){
            	HX_STACK_FRAME("haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","C:\\Haxe\\haxe\\std/haxe/io/BytesBuffer.hx",54,0x246ef3c4)
            	HX_STACK_THIS(this)
...
Dynamic BytesBuffer_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_STACK_FRAME("haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","C:\\Haxe\\haxe\\std/haxe/io/BytesBuffer.hx",191,0x246ef3c4)
            	HX_STACK_THIS(this)
