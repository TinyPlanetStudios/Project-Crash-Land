...
void Path_obj::__construct(::String path){
            	HX_STACK_FRAME("haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","C:\\Haxe\\haxe\\std/haxe/io/Path.hx",76,0x33f4c228)
            	HX_STACK_THIS(this)
...
::String Path_obj::directory(::String path){
            	HX_STACK_FRAME("haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","C:\\Haxe\\haxe\\std/haxe/io/Path.hx",147,0x33f4c228)
            	HX_STACK_ARG(path,"path")
...
::String Path_obj::addTrailingSlash(::String path){
            	HX_STACK_FRAME("haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","C:\\Haxe\\haxe\\std/haxe/io/Path.hx",262,0x33f4c228)
            	HX_STACK_ARG(path,"path")
...
::String Path_obj::removeTrailingSlashes(::String path){
            	HX_STACK_FRAME("haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","C:\\Haxe\\haxe\\std/haxe/io/Path.hx",287,0x33f4c228)
            	HX_STACK_ARG(path,"path")
