...
Int Input_obj::readByte(){
            	HX_STACK_FRAME("haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","C:\\Haxe\\haxe\\std/haxe/io/Input.hx",48,0xdf4c0225)
            	HX_STACK_THIS(this)
...
void Input_obj::close(){
            	HX_STACK_FRAME("haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","C:\\Haxe\\haxe\\std/haxe/io/Input.hx",89,0xdf4c0225)
            	HX_STACK_THIS(this)
            	}
...
::String Input_obj::readLine(){
            	HX_STACK_FRAME("haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","C:\\Haxe\\haxe\\std/haxe/io/Input.hx",174,0xdf4c0225)
            	HX_STACK_THIS(this)
