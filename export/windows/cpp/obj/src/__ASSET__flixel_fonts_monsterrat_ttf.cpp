...
::String filename = __o_filename.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACK_FRAME("__ASSET__flixel_fonts_monsterrat_ttf","new",0x5ab5a7f2,"__ASSET__flixel_fonts_monsterrat_ttf.new","DefaultAssetLibrary.hx",602,0x0fc48912)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(filename,"filename")
            	HX_STACK_ARG(style,"style")
            	HX_STACK_ARG(type,"type")
HXLINE( 602)		super::__construct(filename,style,type);
            	}
