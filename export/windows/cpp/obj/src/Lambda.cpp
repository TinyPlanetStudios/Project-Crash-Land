...
::cpp::VirtualArray Lambda_obj::array( ::Dynamic it){
            	HX_STACK_FRAME("Lambda","array",0x9c8b0512,"Lambda.array","C:\\Haxe\\haxe\\std/Lambda.hx",44,0x46d0a0a6)
            	HX_STACK_ARG(it,"it")
...
Bool Lambda_obj::has( ::Dynamic it, ::Dynamic elt){
            	HX_STACK_FRAME("Lambda","has",0x3d8bd693,"Lambda.has","C:\\Haxe\\haxe\\std/Lambda.hx",124,0x46d0a0a6)
            	HX_STACK_ARG(it,"it")
