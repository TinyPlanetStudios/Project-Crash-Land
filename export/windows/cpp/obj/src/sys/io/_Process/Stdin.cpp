...
void Stdin_obj::__construct( ::Dynamic p){
            	HX_STACK_FRAME("sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",31,0x632af788)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(p,"p")
HXLINE(  32)		this->p = p;
...
void Stdin_obj::close(){
            	HX_STACK_FRAME("sys.io._Process.Stdin","close",0xbd3fe37b,"sys.io._Process.Stdin.close","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",36,0x632af788)
            	HX_STACK_THIS(this)
...
void Stdin_obj::writeByte(Int c){
            	HX_STACK_FRAME("sys.io._Process.Stdin","writeByte",0xfb987cca,"sys.io._Process.Stdin.writeByte","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",41,0x632af788)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(c,"c")
...
Int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,Int pos,Int len){
            	HX_STACK_FRAME("sys.io._Process.Stdin","writeBytes",0x29d4b469,"sys.io._Process.Stdin.writeBytes","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",47,0x632af788)
            	HX_STACK_THIS(this)
