...
void Stdout_obj::__construct( ::Dynamic p,Bool out){
            	HX_STACK_FRAME("sys.io._Process.Stdout","new",0xc765a8f4,"sys.io._Process.Stdout.new","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",63,0x632af788)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(p,"p")
...
Int Stdout_obj::readByte(){
            	HX_STACK_FRAME("sys.io._Process.Stdout","readByte",0xa72b886a,"sys.io._Process.Stdout.readByte","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",69,0x632af788)
            	HX_STACK_THIS(this)
...
Int Stdout_obj::readBytes( ::haxe::io::Bytes str,Int pos,Int len){
            	HX_STACK_FRAME("sys.io._Process.Stdout","readBytes",0x9eebd4c9,"sys.io._Process.Stdout.readBytes","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",75,0x632af788)
            	HX_STACK_THIS(this)
