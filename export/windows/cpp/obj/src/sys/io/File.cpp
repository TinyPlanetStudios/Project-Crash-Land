...
::String File_obj::getContent(::String path){
            	HX_STACK_FRAME("sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",30,0xcd87d049)
...
Bool binary = __o_binary.Default(true);
            	HX_STACK_FRAME("sys.io.File","write",0xfec8a9f4,"sys.io.File.write","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",55,0xcd87d049)
            	HX_STACK_ARG(path,"path")
