...
void FileOutput_obj::__construct( ::Dynamic f){
            	HX_STACK_FRAME("sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",32,0x5de57208)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
void FileOutput_obj::writeByte(Int c){
            	HX_STACK_FRAME("sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",36,0x5de57208)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(c,"c")
HXLINE(  36)		try {
...
Int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,Int p,Int l){
            	HX_STACK_FRAME("sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",40,0x5de57208)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(p,"p")
            	HX_STACK_ARG(l,"l")
...
void FileOutput_obj::close(){
            	HX_STACK_FRAME("sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",47,0x5de57208)
            	HX_STACK_THIS(this)
