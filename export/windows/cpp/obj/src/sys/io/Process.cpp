...
void Process_obj::__construct(::String cmd,::Array< ::String > args){
            	HX_STACK_FRAME("sys.io.Process","new",0x849b4c7a,"sys.io.Process.new","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",96,0x632af788)
            	HX_STACK_THIS(this)
...
void Process_obj::close(){
            	HX_STACK_FRAME("sys.io.Process","close",0x0a954e52,"sys.io.Process.close","C:\\Haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",112,0x632af788)
            	HX_STACK_THIS(this)
