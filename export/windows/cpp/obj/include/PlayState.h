...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		::Array< ::Dynamic> Covers;
		::Array< ::Dynamic> Interactables;
		 ::entity::Interactable TrapDoor;
		 ::entity::Interactable TNT;
		 ::entity::Interactable Rockwall;
		 ::entity::Interactable FuelCell;
		 ::entity::Interactable KeyDoor;
		 ::entity::Interactable Fin;
		 ::entity::Interactable CodeDoor;
		 ::entity::Interactable NoseCap;
		...
		void openMessage(::String m);
		::Dynamic openMessage_dyn();
